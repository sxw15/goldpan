...
CREATE TABLE `__new_processing_tasks` (
	...
	CONSTRAINT "error_kind_enum" CHECK("__new_processing_tasks"."error_kind" IS NULL OR "__new_processing_tasks"."error_kind" IN ('schema_validation', 'content_policy', 'content_length', 'rate_limit', 'timeout', 'not_found', 'unknown')),
